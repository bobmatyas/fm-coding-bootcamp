...
const testimonialSwap = (slideTo) => {
    ...
    const testimonialPhoto = document.getElementById('testiomonialPhoto');
    ...
    const testimonialName = document.getElementById('testiomonialName');
...
const testimonial = document.getElementById('swapTestimonial');
